...
export function registerCreationTools(server: McpServer, connector: FigmaConnector) {
  ...
  srv.tool(
    "figma_create_child",
    "Create a new child node inside a parent",
    {
  ...
  srv.tool(
    "figma_set_text",
    "Set text content and optional style on a text node",
    {
  ...
  srv.tool(
    ...
    "Set an image fill on one or more nodes",
    {
  ...
  srv.tool(
    "figma_move_node",
    "Move a node to absolute coordinates",
    {
  ...
  srv.tool(
    ...
    "Auto-generate documentation for a component",
    {
