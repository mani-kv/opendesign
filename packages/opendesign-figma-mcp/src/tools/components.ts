...
export function registerComponentTools(server: McpServer, connector: FigmaConnector, _restClient: FigmaRestClient) {
  ...
  srv.tool(
    ...
    "Get detailed component info including properties and variants",
    {
      nodeId: z.string().describe("The component node ID"),
    },
    async (params: any) => {
  ...
  srv.tool(
    ...
    "Get component data optimized for development handoff",
    {
      nodeId: z.string().describe("The component node ID"),
    },
    async (params: any) => {
  ...
  srv.tool(
    ...
    "Get a rendered image of a component",
    {
      nodeId: z.string().describe("The component node ID"),
    ...
    async (params: any) => {
      const result = await connector.getComponentImage({
  ...
  srv.tool(
    ...
    "Get a summary of the design system (colors, typography, spacing)",
    {},
    async () => {
  ...
  srv.tool(
    ...
    "Get the full design system kit with all tokens and components",
    {},
    async () => {
