...
- Core pieces:
  ...
  - `packages/desktop-electron`: The native desktop app, built with Electron (wraps `packages/app`)
...
The desktop app is an Electron shell that wraps the web UI.
...
- `fix(desktop-electron):` bug fix in the desktop package
...
- `fix(desktop-electron): resolve crash on startup`
